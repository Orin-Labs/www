...
export function STEMElectivesGuide() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        "Monitor your student's social connections and stress levels. If acceleration isolates them from peers or creates excessive pressure, consider enrichment within grade-level courses instead. Social-emotional development is equally important. For comprehensive support options, explore our <a href='/blog/advanced-academics/gifted-program-navigation'>gifted program navigation guide</a>.",
      icon: Heart,
    },
  ];
  ...
  return (
    <BlogLayout>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-700 mb-4">
              ...
              for more advanced electives,{" "}
              <a href="/blog/advanced-academics/dual-enrollment-guide">
                dual enrollment
              </a>
              , or specialized programs in high school. It also demonstrates
              sustained academic commitment to colleges and can provide valuable
              time for exploring interests or pursuing other activities.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-700">
              ...
              provides crucial context for these acceleration decisions.
            </p>
          </div>
        </div>
      </BlogSection>
          ...
          scenarios={[
            {
              ...
              description:
                "Red flags that suggest waiting. For math skill building, see our <a href='/blog/math-foundations'>comprehensive math playbook</a>.",
              details: [
      ...
      <BlogSection title="Step 8 - Action Planning Checklist">
        ...
        <div className="bg-purple-50 border-l-4 border-purple-400 p-6 rounded-lg mt-8">
          <h4 className="font-bold text-purple-800 mb-2">
            📈 Prerequisites for Advanced Academics
          </h4>
          <p className="text-purple-700 mb-4">
            Before pursuing advanced opportunities, ensure your student has:
          </p>
          <ul className="text-purple-700 space-y-2">
            <li>
              • <strong>Strong assessment scores:</strong> Review{" "}
            ...
            <li>
              • <strong>Solid math foundations:</strong> Use our{" "}
            ...
            <li>
              • <strong>Consistent performance:</strong> Track progress through{" "}
